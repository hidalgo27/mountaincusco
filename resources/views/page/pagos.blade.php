...
@section('title')
    <title>Pagos - Mountain Cusco Tours</title>
@endsection
@section('title_header')
    <h1 class="text-xl mb-6 font-bold font-cinzel text-secondary">Medios</h1>
    <h3 class="md:text-5xl text-3xl font-semibold tracking-widest text-gray-50">Pagos</h3>
    ...
    <div class="grid md:grid-cols-4 grid-cols-1 lg:mx-10 mx-5 gap-10">
        <div class="md:col-span-3">
            <section class="lg:mb-20 lg:mt-24 md:my-16 my-10 lg:justify-between lg:flex">
                <div class="relative">
                    <h2 class="md:text-5xl text-3xl font-semibold z-30 text-primary relative">Pagos</h2>
                    <h4 class="md:text-8xl text-5xl font-bold inset-0 text-gray-100 text-opacity-90 absolute z-10 md:-top-10 -top-2">Medios</h4>
                </div>

            </section>
            <section class="px-5">
                <div class="relative">
                    <p>Nuestros medio de pagos.</p>
